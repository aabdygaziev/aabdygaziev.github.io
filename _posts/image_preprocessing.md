...
```python
img = plt.imread('jailoo.jpeg') # uploading an image
print(img.shape)
```
...
![png](image_preprocessing_files/image_preprocessing_7_0.png)
...
![png](image_preprocessing_files/image_preprocessing_15_0.png)
...
* <font color='red'> **Index 0 - Red = 48** </font>
* <font color='green'> **Index 1 - Green = 100** </font>
* <font color='blue'> **Index 2 - Blue = 139** </font>
...
![png](image_preprocessing_files/image_preprocessing_20_0.png)
...
![png](image_preprocessing_files/image_preprocessing_21_0.png)
...
for c, ax in zip(range(3), axs):
    image = np.zeros(img.shape, dtype="uint8")
    image[:,:,c] = img[:,:,c]
    ax.imshow(image)
    ax.set_axis_off()
```
